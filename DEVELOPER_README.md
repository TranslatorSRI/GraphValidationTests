...
3. Update the **`[Tool Poetry]version =`** field in the **pyprojects.yaml**, e.g. "0.0.5"
...
7. Add the equivalent Git **tag** to **main**. This should be the Semantic Version string from step 4 with an added 'v' prefix, i.e. "v0.0.5".
8. Push **main** to remote.
9. Check if Git Actions for testing and documentation complete successfully.
10. Create a Git package release using the same release tag, i.e. "v0.0.5".
11. Check if Git Actions for package deployment is successful and check if the new version (i.e. "v0.0.5") is now visible on **[pypy.org](https://pypi.org/search/?q=OneHopTests)**
